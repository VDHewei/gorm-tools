...
type Options struct {
	...
	ModelNameSignable     *bool    `env:"GEN_MODEL_NAME_SIGNABLE" json:"modelNameSignable" long:"modelNameSignable" description:"keep model names and table names consistent, without using plural rewriting"`
